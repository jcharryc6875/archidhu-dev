...
/**
 * FactUsuarioRequisitor filter form base class.
 *
 * @package    simad
 * @subpackage filter
 * @author     Your name here
 */
abstract class BaseFactUsuarioRequisitorFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('fact_usuario_requisitor_filters[%s]');
  ...
  {
    return array(
      'FACTUSUARIOREQUISITOR_ID'     => 'Number',
