 ...
 */
abstract class BaseTipoUsuario extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    ...
    /**
     * Initializes internal state of BaseTipoUsuario object.
     * @see        applyDefaults()
     */
    ...
    public function setTipousuarioId($v)
    {
        ...
        if ($this->tipousuario_id !== $v) {
            ...
            $this->modifiedColumns[] = TipoUsuarioPeer::TIPOUSUARIO_ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = TipoUsuarioPeer::DESCRIPCION;
        }
    ...
    public function setEsVisible($v)
    {
        ...
        if ($this->es_visible !== $v) {
            $this->es_visible = $v;
            $this->modifiedColumns[] = TipoUsuarioPeer::ES_VISIBLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tipousuario_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = TipoUsuarioPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($criteria->keyContainsValue(TipoUsuarioPeer::TIPOUSUARIO_ID) ) {
        ...
        $this->setTipousuarioId($pk);  //[IMV] update autoincrement primary key
        $this->setNew(false);
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setTipousuarioId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TipoUsuarioPeer::TIPOUSUARIO_ID)) $criteria->add(TipoUsuarioPeer::TIPOUSUARIO_ID, $this->tipousuario_id);
        if ($this->isColumnModified(TipoUsuarioPeer::DESCRIPCION)) $criteria->add(TipoUsuarioPeer::DESCRIPCION, $this->descripcion);
        if ($this->isColumnModified(TipoUsuarioPeer::ES_VISIBLE)) $criteria->add(TipoUsuarioPeer::ES_VISIBLE, $this->es_visible);
    ...
    {
        $criteria = new Criteria(TipoUsuarioPeer::DATABASE_NAME);
        $criteria->add(TipoUsuarioPeer::TIPOUSUARIO_ID, $this->tipousuario_id);
    ...
    /**
     * Generic method to set the primary key (tipousuario_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getTipousuarioId();
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setTipousuarioId(NULL); // this is a auto-increment column, so set to default value
        }
    }
    ...
    public function setUsuarios(PropelCollection $usuarios, PropelPDO $con = null)
    {
        ...
        foreach ($usuariosToDelete as $usuarioRemoved) {
            $usuarioRemoved->setTipoUsuario(null);
        }
     ...
     * Otherwise if this TipoUsuario is new, it will return
     * an empty collection; or if this TipoUsuario has previously
     * been saved, it will retrieve related Usuarios from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TipoUsuario.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(TipoUsuarioPeer::DEFAULT_STRING_FORMAT);
    }
