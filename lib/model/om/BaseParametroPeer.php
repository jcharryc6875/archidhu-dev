...
abstract class BaseParametroPeer
{
    ...
    /** the column name for the PARAMETRO_ID field */
    const PARAMETRO_ID = 'PARAMETRO.PARAMETRO_ID';

    /** the column name for the CODIGO field */
    const CODIGO = 'PARAMETRO.CODIGO';

    /** the column name for the DESCRIPCION field */
    const DESCRIPCION = 'PARAMETRO.DESCRIPCION';

    /** the column name for the VALORTEXTO field */
    const VALORTEXTO = 'PARAMETRO.VALORTEXTO';

    /** the column name for the VALOR_NUMERICO field */
    const VALOR_NUMERICO = 'PARAMETRO.VALOR_NUMERICO';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Parametro objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ParametroId', 'Codigo', 'Descripcion', 'Valortexto', 'ValorNumerico', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('parametroId', 'codigo', 'descripcion', 'valortexto', 'valorNumerico', ),
        BasePeer::TYPE_COLNAME => array (ParametroPeer::PARAMETRO_ID, ParametroPeer::CODIGO, ParametroPeer::DESCRIPCION, ParametroPeer::VALORTEXTO, ParametroPeer::VALOR_NUMERICO, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PARAMETRO_ID', 'CODIGO', 'DESCRIPCION', 'VALORTEXTO', 'VALOR_NUMERICO', ),
        BasePeer::TYPE_FIELDNAME => array ('PARAMETRO_ID', 'CODIGO', 'DESCRIPCION', 'VALORTEXTO', 'VALOR_NUMERICO', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ParametroId' => 0, 'Codigo' => 1, 'Descripcion' => 2, 'Valortexto' => 3, 'ValorNumerico' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('parametroId' => 0, 'codigo' => 1, 'descripcion' => 2, 'valortexto' => 3, 'valorNumerico' => 4, ),
        BasePeer::TYPE_COLNAME => array (ParametroPeer::PARAMETRO_ID => 0, ParametroPeer::CODIGO => 1, ParametroPeer::DESCRIPCION => 2, ParametroPeer::VALORTEXTO => 3, ParametroPeer::VALOR_NUMERICO => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PARAMETRO_ID' => 0, 'CODIGO' => 1, 'DESCRIPCION' => 2, 'VALORTEXTO' => 3, 'VALOR_NUMERICO' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('PARAMETRO_ID' => 0, 'CODIGO' => 1, 'DESCRIPCION' => 2, 'VALORTEXTO' => 3, 'VALOR_NUMERICO' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ParametroPeer::PARAMETRO_ID);
            $criteria->addSelectColumn(ParametroPeer::CODIGO);
            $criteria->addSelectColumn(ParametroPeer::DESCRIPCION);
            $criteria->addSelectColumn(ParametroPeer::VALORTEXTO);
            $criteria->addSelectColumn(ParametroPeer::VALOR_NUMERICO);
        } else {
            $criteria->addSelectColumn($alias . '.PARAMETRO_ID');
            $criteria->addSelectColumn($alias . '.CODIGO');
            $criteria->addSelectColumn($alias . '.DESCRIPCION');
            $criteria->addSelectColumn($alias . '.VALORTEXTO');
            $criteria->addSelectColumn($alias . '.VALOR_NUMERICO');
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Parametro) {
                $key = (string) $value->getParametroId();
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (ParametroPeer::$instances as $instance) {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ParametroPeer::PARAMETRO_ID) && $criteria->keyContainsValue(ParametroPeer::PARAMETRO_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ParametroPeer::PARAMETRO_ID);
            $value = $criteria->remove(ParametroPeer::PARAMETRO_ID);
            if ($value) {
                $selectCriteria->add(ParametroPeer::PARAMETRO_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ParametroPeer::PARAMETRO_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ParametroPeer::DATABASE_NAME);
        $criteria->add(ParametroPeer::PARAMETRO_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ParametroPeer::DATABASE_NAME);
            $criteria->add(ParametroPeer::PARAMETRO_ID, $pks, Criteria::IN);
