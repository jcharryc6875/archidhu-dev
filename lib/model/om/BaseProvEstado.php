...
/**
 * Base class that represents a row from the 'PROV_ESTADO' table.
 *
 * 
 *
 ...
 */
abstract class BaseProvEstado extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProvEstadoPeer';
     ...
     * @return ProvEstado The current object (for fluent API support)
     */
    public function setProvEstadoId($v)
    {
        ...
        if ($this->prov_estado_id !== $v) {
            ...
            $this->modifiedColumns[] = ProvEstadoPeer::PROV_ESTADO_ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = ProvEstadoPeer::DESCRIPCION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->prov_estado_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 2; // 2 = ProvEstadoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProvEstado object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProvEstadoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProvEstadoQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseProvEstado:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseProvEstado:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseProvEstado:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseProvEstado:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                ProvEstadoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($criteria->keyContainsValue(ProvEstadoPeer::PROV_ESTADO_ID) ) {
        ...
        $this->setProvEstadoId($pk);  //[IMV] update autoincrement primary key
        $this->setNew(false);
    }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProvEstadoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProvEstadoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProvEstado'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProvEstado'][$this->getPrimaryKey()] = true;
        $keys = ProvEstadoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getProvEstadoId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setProvEstadoId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProvEstadoPeer::PROV_ESTADO_ID)) $criteria->add(ProvEstadoPeer::PROV_ESTADO_ID, $this->prov_estado_id);
        if ($this->isColumnModified(ProvEstadoPeer::DESCRIPCION)) $criteria->add(ProvEstadoPeer::DESCRIPCION, $this->descripcion);
    ...
    {
        $criteria = new Criteria(ProvEstadoPeer::DATABASE_NAME);
        $criteria->add(ProvEstadoPeer::PROV_ESTADO_ID, $this->prov_estado_id);
    ...
    /**
     * Generic method to set the primary key (prov_estado_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getProvEstadoId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProvEstado (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setProvEstadoId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProvEstado Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProvEstadoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProvEstadoPeer();
        }
     ...
     * If this ProvEstado is new, it will return
    ...
    public function setProveedors(PropelCollection $proveedors, PropelPDO $con = null)
    {
        ...
        foreach ($proveedorsToDelete as $proveedorRemoved) {
            $proveedorRemoved->setProvEstado(null);
        }
     ...
     * Otherwise if this ProvEstado is new, it will return
     * an empty collection; or if this ProvEstado has previously
     * been saved, it will retrieve related Proveedors from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ProvEstado.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProvEstadoPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseProvEstado:' . $name))
        {
