...
class ParametroTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('PARAMETRO_ID', 'ParametroId', 'INTEGER', true, 4, null);
        $this->addColumn('CODIGO', 'Codigo', 'VARCHAR', false, 50, null);
        $this->addColumn('DESCRIPCION', 'Descripcion', 'VARCHAR', false, 250, null);
        $this->addColumn('VALORTEXTO', 'Valortexto', 'VARCHAR', false, 200, null);
        $this->addColumn('VALOR_NUMERICO', 'ValorNumerico', 'INTEGER', false, 4, null);
        // validators
    } // initialize()
