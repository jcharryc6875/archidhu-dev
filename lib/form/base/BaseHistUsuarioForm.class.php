...
/**
 * HistUsuario form base class.
 *
 * @method HistUsuario getObject() Returns the current form's model object
 *
 * @package    ##PROJECT_NAME##
 * @subpackage form
 * @author     ##AUTHOR_NAME##
 */
abstract class BaseHistUsuarioForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      'HISTUSUARIO_ID'      => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      'HISTUSUARIO_ID'      => new sfValidatorChoice(array('choices' => array($this->getObject()->getHistusuarioId()), 'empty_value' => $this->getObject()->getHistusuarioId(), 'required' => false)),
      ...
      'RUTA_FOTO'           => new sfValidatorString(array('max_length' => 100, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('hist_usuario[%s]');
