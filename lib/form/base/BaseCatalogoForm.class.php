 ...
 * @author     ##AUTHOR_NAME##
 */
abstract class BaseCatalogoForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      'CATALOGO_ID'             => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      'CATALOGO_ID'             => new sfValidatorChoice(array('choices' => array($this->getObject()->getCatalogoId()), 'empty_value' => $this->getObject()->getCatalogoId(), 'required' => false)),
