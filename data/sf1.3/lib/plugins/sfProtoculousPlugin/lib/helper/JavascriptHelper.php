  ...
  function update_element_function($element_id, $options = array())
  {
    ...
    switch ($value)
    {
      case 'update':
        ...
        {
          $javascript_function = "\jQuery('$element_id').insert({'".$options['position']."':'$content'})";
        }
        else
        {
          $javascript_function = "\jQuery('$element_id').update('$content')";
        }
        break;

      case 'empty':
        $javascript_function = "\jQuery('$element_id').innerHTML = ''";
        break;
