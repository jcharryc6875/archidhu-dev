...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $base_url ?>theme/neon/assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css">
        <link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/css/font-icons/entypo/css/entypo.css"/>
    	<link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/css/bootstrap.css"/>
    	<link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/css/neon-core.css"/>
    	<link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/css/neon-theme.css"/>
    	<link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/css/neon-forms.css"/>            
        <link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/js/select2/select2-bootstrap.css"/>
        <link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/js/select2/select2.css"/>
        <link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/css/skins/yellow.css" rel="stylesheet"/>
        <link rel="stylesheet" href="<?php echo $base_url; ?>theme/neon/assets/css/custom.css"/>
             	
        <script src="<?php echo $base_url; ?>theme/neon/assets/js/jquery-1.11.0.min.js"></script>
		...
		.pager li > a, .pager li > span {
			background-color: #0ab614;
			color: #ffffff;
		}
		.pager li > a:hover, .pager li > a:focus {
			text-decoration: none;
			background-color: #1313e9;
		}
		.pager .disabled li > a, .pager li .disabled > span {
			background-color: #0ab614;
			color: #ffffff;
		}
        </style>
                                            ...
                                            <div class="tab-pane" id="tab2-5">
                                                ...
                                                <div align="right">
                        							<button id="submitajax" class="btn btn-success btn-large">
                        								<i class="glyphicon glyphicon-floppy-saved"></i> Radicar Solicitud
                        							</button>
													<img src="img/spinner.gif" id="ajaxspinner" style="display: none;" />
													<button type="button" class="btn btn-red btn-large endradprocess">
                        								<i class="glyphicon glyphicon-remove-sign icon-white"></i> Cancelar
                        							</button>
                        						</div>
                                                <!--div class="form-group">
    		...
    		<div class="modal-dialog">
    			<div class="modal-content">
    				...
    				<div class="modal-footer">
						<button type="button" class="btn btn-info endradprocess" data-dismiss="modal">Finalizar</button>
    				</div>
    			</div>
    		</div>
    	</div>    
...
<script src="<?php echo $path_theme; ?>assets/js/neon-api.js?v=<?php echo(rand()); ?>"></script>
<script src="<?php echo $path_theme; ?>assets/js/simad-api.js?v=<?php echo(rand()); ?>"></script>
