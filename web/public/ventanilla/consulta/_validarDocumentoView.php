<?php 
    ...
    {
?>
<div class="col-md-8" id="<?php echo md5('strlistinfodoc2');?>">
<?php  
    }
?>
                    ...
                    else
                    {
                        if($verificado_hash)
                        {
                            ...
                            <div class="col-sm-12 col-md-12">  
                                ...
                                <div class="row">					
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-8"> 
                                            <p>
                                                <?php 
                                                    //echo $com_enviadas['RADICADO_FLUJO'][1]['USUARIO_ACTIVIDAD'];
                                ...
                                <div class="row">
                                        <?php
                                            echo '<div class="panel-heading"><div class="panel-title" style="color:green; font-size: 24px !important;">EL DOCUMENTO ADJUNTADO ES AUT&Eacute;NTICO</div></div>';
                                        ?>
                                </div>
                            </div>
                            <hr />
                        ...
                        else
                        {
                            ?>
                                <div class="panel-body">
                                    <div class="alert alert-danger"><strong>EL DOCUMENTO ADJUNTADO NO ES AUTENTICO, ES INVALIDO</strong></div>
                                </div>
                            <?php
                        }
                    }
