...
jQuery(document).ready(function()
{
    ...
    jQuery('#submitajax').on( "click", function(event)
    {
...
<script src="<?php echo $base_url; ?>theme/neon/assets/js/gsap/main-gsap.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/jquery-ui/js/jquery-ui-1.10.3.minimal.min.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/bootstrap.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/joinable.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/resizeable.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/neon-api.js"></script>
    
<!-- Imported scripts on this page -->
<script src="<?php echo $base_url; ?>theme/neon/assets/js/jquery.bootstrap.wizard.min.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/jquery.validate.min.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/jquery-validate-messages_es.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/jquery.inputmask.bundle.min.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/select2/select2.min.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/select2/select2_locale_es.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/bootstrap-datepicker.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/bootstrap-timepicker.min.js"></script>
<script src="<?php echo $base_url; ?>theme/neon/assets/js/external-custom.js"></script>
<script>
