			...
			submitHandler: function(ev)
			{
				...
				neonForgotPassword.setPercentage(30, function()
				{
					...
					neonForgotPassword.setPercentage(98, function()
					{
						...
						$.ajax({
							url: baseurl + '/administracion.php/usuario/updateRecuperarPassword',
							method: 'POST',
							dataType: 'json',
							data: {
							...
							error: function(response)
							{
								...
								var error = response.responseJSON.submitted_data.error;
                                // Remove loging-in state
							    $(".login-page").removeClass('logging-in');
								
								if(error == 0){
									console.log(response.responseJSON.submitted_data);
									...
									setTimeout(function()
									{
										...
										neonForgotPassword.$steps.slideUp('normal', function()
										{
											...
											$(".form-forgotpassword-success" ).show();
											$(".form-forgotpassword-success p").text(response.responseJSON.submitted_data.mensaje);
									...
									setTimeout(function()
									{
										...
										neonForgotPassword.$steps.slideUp('normal', function()
										{
											...
											// Now we show the success message
											$(".form-login-error p").text(response.responseJSON.submitted_data.mensaje);
							...
							success: function(response)
							{
								...
								var error = response.submitted_data.error;
								...
								if(error == 0){
									...
									setTimeout(function()
									{
										...
										neonForgotPassword.$steps.slideUp('normal', function()
										{
											...
											// Now we show the success message
											$(".form-forgotpassword-success" ).show();
											$(".form-forgotpassword-success p").text(response.submitted_data.mensaje);
											$(".form-forgotpassword-success").slideDown('normal');
									...
									setTimeout(function()
									{
										...
										neonForgotPassword.$steps.slideUp('normal', function()
										{
											...
											// Now we show the success message
											$(".form-login-error p").text(response.submitted_data.mensaje);
											$(".form-login-error").slideDown('normal');
											$(".form-login-error" ).show();
