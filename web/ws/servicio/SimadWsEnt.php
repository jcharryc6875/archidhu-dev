<?php
	...
	//*************************************************************************************************************************
	$remitentes_response = array ( 'directorioexterno_id' => array( 'name'=>'directorioexterno_id' , 'type'=>'xsd:string'),
			'ciudad' => array( 'name'=>'ciudad'  , 'type'=>'xsd:string'),
	...
	//*************************************************************************************************************************
	$attach_response = array ( 'CONSECUTIVO_ID' => array( 'name'=>'CONSECUTIVO_ID' , 'type'=>'xsd:int'),
	...
	//*************************************************************************************************************************
	$viewattach_list = array ( 'GUID' => array( 'name'=>'GUID' , 'type'=>'xsd:string'),
	...
	//*************************************************************************************************************************
	$viewattach_response = array ('LIST_DOCUMENTOS' => array( 'name'=>'LIST_DOCUMENTOS', 'type'=>'tns:AttachComOfList', 'minOccurs' => 1, 'maxOccurs' => 1),
		//'URL_ACCESO' => array( 'name'=>'URL_ACCESO' , 'type'=>'xsd:string'),
	...
	//*************************************************************************************************************************
	$search_attach = array ('RADICADO_COMUNICACION' => array( 'name'=>'RADICADO_COMUNICACION', 'type'=>'xsd:string', 'minOccurs' => 1, 'maxOccurs' => 1),
	...
	//*************************************************************************************************************************
	$comenviada_oferta = array ( 'SERIE' => array( 'name'=>'SERIE', 'type'=>'xsd:string', 'minOccurs' => 1, 'maxOccurs' => 1),
	...
	//*************************************************************************************************************************
	$document_attach = array ('ARCHIVO_DATA' => array( 'name'=>'ARCHIVO_DATA', 'type'=>'xsd:string', 'minOccurs' => 1, 'maxOccurs' => 1),
		'ARCHIVO_NOMBRE' => array( 'name'=>'ARCHIVO_NOMBRE', 'type'=>'xsd:string', 'minOccurs' => 1, 'maxOccurs' => 1),
	...
	//*************************************************************************************************************************
	$interesados_incoming = array ( 'INTERESADO_ID' => array( 'name'=>'INTERESADO_ID', 'type'=>'xsd:string', 'minOccurs' => 0, 'maxOccurs' => 1),
		'PRIMER_NOMBRE' => array( 'name'=>'PRIMER_NOMBRE', 'type'=>'xsd:string', 'minOccurs' => 1, 'maxOccurs' => 1),
		'SEGUNDO_NOMBRE' => array( 'name'=>'SEGUNDO_NOMBRE', 'type'=>'xsd:string', 'minOccurs' => 0, 'maxOccurs' => 0),
		'PRIMER_APELLIDO' => array( 'name'=>'PRIMER_APELLIDO' , 'type'=>'xsd:string', 'minOccurs' => 1, 'maxOccurs' => 1),
		'SEGUNDO_APELLIDO' => array( 'name'=>'SEGUNDO_APELLIDO', 'type'=>'xsd:string', 'minOccurs' => 0, 'maxOccurs' => 1),
	...
	//*************************************************************************************************************************
	$servicio_incoming = array ( 'PUNTO_RADICACION' => array( 'name'=>'PUNTO_RADICACION', 'type'=>'xsd:string', 'minOccurs' => 1, 'maxOccurs' => 1),
	...
	//*************************************************************************************************************************
	$serviciocom_response = array ( 'CONSECUTIVO_ID' => array( 'name'=>'CONSECUTIVO_ID' , 'type'=>'xsd:int'),
		'RADICADO' => array( 'name'=>'RADICADO'  , 'type'=>'xsd:string'),
		'FECHA_CREACION' => array( 'name'=>'FECHA_CREACION' , 'type'=>'xsd:string'),
		'FECHA_TRANSACCION' => array( 'name'=>'FECHA_TRANSACCION' , 'type'=>'xsd:string'),
		'ISERROR' =>  array( 'name'=>'ISERROR' , 'type'=>'xsd:boolean'),
