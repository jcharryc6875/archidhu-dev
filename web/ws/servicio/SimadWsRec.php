...
$server->wsdl->addSimpleType(
	...
	'SimpleType',
	'scalar',
	TipoIdentificacionPeer::getTipoIdentificacionList()
);
//*************************************************************************************************************************
$server->wsdl->addSimpleType(
	'empresaMensajeria',
	...
	'SimpleType',
	'scalar',
	EmpresaMensajeriaPeer::getCourrierListName()
);
//*************************************************************************************************************************
$comrecibida_incoming = array(
...
//*************************************************************************************************************************
$radicado_lattacts = array(
	'NOMBRE_ANEXO' => array('name' => 'NOMBRE_ARCHIVO', 'type' => 'xsd:string'),
...
//*************************************************************************************************************************
$servicio_com = array(
	'RADICADO_SERVICIO' => array('name' => 'RADICADO_SERVICIO', 'type' => 'xsd:string'),
