...
//$configuration = ProjectConfiguration::getApplicationConfiguration('comun', 'dev', false);
$configuration = ProjectConfiguration::getApplicationConfiguration('comun', 'prod', false);
