...
var js_options = {
	...
	highlightColor: '#FFFF98', //default color should be:  #FFFF99
	endColor: '#FF0000', //this is what you generally want to set to the background color behind the form elements.
	extMessage: true , // if true, and you have accept value on file input, it tells user what extensions are accepted.
	loading_name_div_fondo: 'indicator_fondo' , // apply this class inside any form to let this element submit the form.
	loading_name_div_img: 'indicator' // apply this class inside any form to let this element submit the form.
}
...
var custom_validators = {
	number: {
		...
		defaultMessage: "Este Campo Solo Debe Contener Numeros Separados Por (-).",
		regExp: /^\d+([-])?(\d+)?$/
	},
	digits: {
		className: "jsvalidate_digits",
		defaultMessage: "Este Campo Solo Debe Contener Numeros.",
		regExp: /^\d+(\.\d+)?$/
	},
	email: {
		className: "jsvalidate_email",
		defaultMessage: "Esta Cadena No Es Una Cuenta De Correo Valida.",
	...
	alphanum: {
		...
		defaultMessage: "Este Campo Solo Debe Contener Numeros o Letras.",
		regExp: /^[a-zA-Z0-9\s]+$/
	},
    alphanumlimit: {
		className: "jsvalidate_alphanumlimit",
		defaultMessage: "Debe Contener Maximo 2 Letras Mayusculas y 7 Numeros.",
		regExp: /^[A-Z]{2}[\d]{7}$/
	}
};
...
var js_validators = {
	required: {
		...
		defaultMessage: "Este Campo No Debe Quedar Vacio"
	},
	notfirst: {
...
{
	var indicator_fondo = document.getElementById(js_options['loading_name_div_fondo']);
	var indicator = document.getElementById(js_options['loading_name_div_img']);
	if(indicator_fondo)
	{
		Element.show(js_options['loading_name_div_fondo']);		
	}
	if(indicator)
	{
		Element.show(js_options['loading_name_div_img']);
	}
}
