...
<?php
    ...
    if(!isset($_GET['fileview']) || empty($_GET['fileview'])){
        header("Location: /no_file_exists.html");
        exit();
    }else{
        $pdf_file = '/tmp/'.$_GET['fileview'];
    }
		
	$file = $web_path.$pdf_file;    
    if(!file_exists($file)){
      header("Location: /no_file_exists.html");
      exit();
    }
...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <title>ARCHIDHU DocumentViewer</title>


    <link rel="stylesheet" href="<?php echo $path_theme;?>assets/js/pdfjs/viewer.css">
	<script>
		const DEFAULT_URL = "<?php echo $pdf_file; ?>";
		const DEFAULT_WDIR = "<?php echo $pdfjs_wdir; ?>";
	</script>

	<!-- This snippet is used in production (included from viewer.html) -->
	<link rel="resource" type="application/l10n" href="<?php echo $pdfjs_wdir;?>locale/locale.properties">
	<script src="<?php echo $pdfjs_wdir;?>build/pdf.js"></script>
	<script src="<?php echo $pdfjs_wdir;?>viewer.js"></script>
