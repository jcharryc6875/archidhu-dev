...
$currentFormReasignarAll   = "RECIBIDA_REASIGNAR_GESTOR_TODAS_ENTIDADES";
?>
    ...
    <div class="panel panel-gradient" data-collapsed="0">      
      <div class="panel-heading">
        <div class="panel-title">
          Asignar Gestor de la Comunicaci&oacute;n
        </div>
      </div>
      ...
      <div class="panel-body">
        <?php 
            echo form_tag('com_recibida/updateAsignarGestor', array('name'=>'form1', 'role' => 'form', 'class' => 'form-horizontal form-groups-bordered validate')); 
        ...
        <?php
          if(!$sf_user->checkPerm($currentFormReasignarAll, $currentUser) && $com_recibida->getTipoprocesocomId() == 3){
            $dependencia_asig = isset($listcom_users['dependencia_asignado']) ? $listcom_users['dependencia_asignado'] : $com_recibida->getDependenciaId();
          }else{
            $dependencia_asig = $com_recibida->getDependenciaId();
          }

          echo component_user_multiple("paraUser","idUser","cargousuarioId",array('url'=>'usuario_firma/selectUserSearching', 'byfilterdep'=>SED::encryption($dependencia_asig), 'bytipoprocesocom'=>3, 'caption'=>'Gestor Destino(<span class="ctrlreq">*</span>)', 'buttontitle'=>'Buscar Destinatario','class'=>'form-control input-sm required','values'=>null,'values_text'=>null,'values_cuid'=>null,'option'=>0,'maximumSelectionSize'=>1));
        ?>
