    ...
    <div class="panel panel-gradient" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title">
          Aprobacion Area de Impuestos
        </div>
      </div>
      <!-- Contenedor Contenido Formulario-->
      <div class="panel-body">
        <?php 
        echo form_tag('prov_periodo_validez/updatepaso2', array('name'=>'form1','role' => 'form', 'class' => 'form-horizontal form-groups-bordered validate'));
        echo object_input_hidden_tag($prov_periodo_validez, 'getProvPeriodoValidezId');
        ?>
        
        <div class="form-group">
          <!-- Tipo Procedimiento -->
          <label for="ltipoprocedimiento_id" class="col-sm-1 control-label">Tipo de Retencion:</label>
          <div class="col-sm-4">
            <?php echo object_select_tag($prov_tipo_retencion, 'getProvTipoRetencionId', array (
  'related_class' => 'ProvTipoRetencion','class'=>'form-control input-sm','multiple' => true, 'include_custom'=>'Selecione...',)); ?>
          </div>
          
          <!-- Tipo Procedimiento -->
          <label for="ltipoprocedimiento_id" class="col-sm-1 control-label">Tipo de Contribuyente:</label>
          <div class="col-sm-4">
            <?php echo object_select_tag($prov_periodo_validez, 'getProvTipoContribuyenteId', array ('related_class' => 'ProvTipoContribuyente','class'=>'form-control input-sm', 'include_custom'=>'Selecione...','selected'=>$sf_params->get('pais_id'),)); ?>
