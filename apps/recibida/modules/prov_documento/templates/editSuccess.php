    ...
    <div class="panel panel-gradient" data-collapsed="0">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <!-- Tipo Procedimiento -->
          <label for="ltipoprocedimiento_id" class="col-sm-2 control-label">Tipo de Documento:</label>
          <div class="col-sm-4">       
            <?php echo object_select_tag($prov_documento, 'getProvListaDocsId', array ('related_class' => 'ProvListaDocs','class'=>'form-control input-sm required',)) ?>          
          </div>
          
          <!-- Tipo Procedimiento -->
          <label for="ltipoprocedimiento_id" class="col-sm-2 control-label">Fecha Recibido:</label>
          <div class="col-sm-4">                                    
            <div class="input-group">
             <?php echo  input_tag('fecha_recibido', $prov_documento->getFechaRecibido(), array('class'=>'form-control input-sm datepicker required', 'data-format'=>'yyyy-mm-dd', 'type'=>'text', 'readonly'=>'true',)); ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-offset-4 col-sm-5">
            <button type="submit" class="btn btn-success"><?php echo $prov_documento->getPrimaryKey() ? "Guardar Documento" : "Guardar Documento"?> </button>
            <?php if ($prov_documento->getPrimaryKey()): ?>
            <?php 
                        echo button_to('Eliminar Documento','prov_documento/delete?prov_documento_id=' . $prov_documento->getPrimaryKey().'&confirm=Esta Seguro?', array('class' => 'btn btn-red tooltip-primary', "data-toggle" => "tooltip", "data-original-title" => "Eliminar Documento")); 
             ?>
            <?php endif; ?>
        </div>
      </div>
