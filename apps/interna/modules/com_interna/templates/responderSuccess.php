    ...
    <div class="panel panel-gradient" data-collapsed="0">      
      <div class="panel-heading">
        <div class="panel-title">
          Responder Comunicaci&oacute;n Interna (<strong><?php echo $com_internaOrigen->getRadicado(); ?></strong>)
        </div>
      </div>
      ...
      <div class="panel-body">
        <?php 
          echo form_tag('com_interna/updateResponder', array('name'=>'form1', 'role' => 'form', 'class' => 'form-horizontal form-groups-bordered validate')); 
          ...
          if($com_internaOrigen->getCodigoReenResp() != ""){
              ...
              echo input_hidden_tag('codigo_reen_resp',$com_internaOrigen->getPrimaryKey() );  
          }
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <?php 
              echo object_select_tag($com_internaOrigen, 'getTipocominternaId', array('peer_method'=>'getTipoComInternaShow','related_class' => 'TipoComInterna','include_custom'=>'Selecione...','class'=>'form-control input-sm required','onchange' =>
        ...
        ?>
          ...
          <div class="col-sm-6">            
            <?php
                $asunto='Respuesta a correspondencia con radicado '.$com_internaOrigen->getRadicado();
        ...
        <div class="form-group">
          ...
          <div class="col-sm-offset-4 col-sm-5">
            ...
            ?>
                <a class="btn btn-blue" href="<?php echo $base_path; ?>/interna.php/com_interna/radicar?cominterna_id=<?php echo $com_interna->getPrimaryKey()?>" >Radicar</a>                
            <?php
            }             
            ?>
