...
<nav class="navbar navbar-default" role="navigation">
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
			...
			<li><a href="<?php print url_for('libro/create'); ?>"><img src="<?php echo $base_path; ?>/theme/neon/assets/images/sub-menu/ico_crear_black.svg" class="submenues" />Crear</a></li>
			<li><a href="<?php print url_for('documentacion_tecnica/consulta?tipo_documentacion_id=4'); ?>"><img src="<?php echo $base_path; ?>/theme/neon/assets/images/sub-menu/ico_consultar_black.svg" class="submenues" />Consultar</a></li>
