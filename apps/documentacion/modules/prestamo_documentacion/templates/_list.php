                ...
                <form action="" method="post" name="form1">
                  <table class="table table-bordered table-hover table-striped responsive">
                      ...
                      <?php
                        ...
                        ?>
                        <tr>
                            <td class="text_center"><?php echo jq_link_to_function($prestamo->getConsecutivoRegional(), 'javascript:jQuery.OpenModalSIMAD("'.$base_path.'/documentacion.php/prestamo_documentacion/show?opcion=1&docprestamo_id='.$prestamo->getDocPrestamoId().'", "960", "640")') ?></td>                                                        
                  ...
                  <div class="row">
                    <div class="col-sm-12 form-group">
                        <?php 
                            echo link_to(image_tag('/images/simad/ico_exportar.png',array('border'=>"0",'width'=>"25",'align'=>"middle",)).'Exportar','/documentacion.php/prestamo_documentacion/excel?'.$parametros,array('class'=>'btn btn-white btn-sm'));
                        ?>
                    </div>
                  </div>
