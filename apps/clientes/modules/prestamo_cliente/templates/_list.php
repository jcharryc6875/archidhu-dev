	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary">
		      ...
		      <div class="panel-body">
		      	<div class="alert alert-default"><strong>No existen Prestamos Clientes</strong>, Intente con diferentes filtros de consulta.</div>
	      	  </div>
      	</div>
		      ...
		      <div class="panel-body with-table">
		      	...
		      	<table class="table table-bordered table-hover table-striped responsive">
		          	...
		          	<tbody>
		          		...
		          		?>
		          		<tr>
		          			<td class="text-center"><?php echo jq_link_to_function($prestamo->getConsecutivoRegional(), 'javascript:jQuery.OpenModalSIMAD("'.$base_path.'/clientes.php/prestamo_cliente/show?prestamo_id='.$prestamo->getClPrestamoId().'")'); ?></td>
