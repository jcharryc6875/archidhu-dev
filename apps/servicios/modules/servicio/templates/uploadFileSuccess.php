...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="panel panel-gradient" data-collapsed="0">
      ...
      <?php 
        echo form_tag('servicio/uploads', array('name'=>'form1', 'multipart'=> true, 'role' => 'form', 'class' => 'form-horizontal form-groups-bordered validate'));
