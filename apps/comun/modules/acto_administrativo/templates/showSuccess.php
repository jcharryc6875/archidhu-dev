                        ...
                        <div id="data" class="tab-pane active">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="col-sm-4">
                                            <p><strong>N&uacute;mero Acto Administrativo:</strong></p>
                                        </div>
                                        <div class="col-sm-8">
                                            <p>
                                                <?php
                                                if ($acto_administrativo->getEstadodigitalizacionId() == 2 && file_exists($digitDocumentFile)) {
                                                    ...
                                                    echo jq_link_to_remote(
                                                        image_tag('simad/' . $ico_ver_adj, array('id' => "feedcheck", 'border' => "0", 'width' => "25", 'height' => "25", 'align' => "middle")),
                                                        array(
                                                            'update'  => null,
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-7">
                                            <p><?php echo $acto_administrativo->getDependencia()->getNombreCustomFull(); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-8">
                                            <p><?php echo ucwords(mb_strtolower($estado)); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="col-sm-5">
                                            <p><strong>Fecha Creaci&oacute;n:</strong></p>
                                        </div>
                                        <div class="col-sm-7">
                                            <p><?php echo $acto_administrativo->getFechaCreacion(); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-8">
                                            <p><?php echo $acto_administrativo->getAsunto(); ?></p>
                                        </div>
                                    </div>

                                    <div class="col-sm-6">
                                        <div class="col-sm-5">
                                            <p><strong>Usuario Proyecta:</strong></p>
                                        </div>
                                        <div class="col-sm-7">
                                            <p><?php echo $radicador; ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php if (trim($acto_administrativo->getFolios()) || trim($acto_administrativo->getRegionalId())) { ?>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="col-sm-4">
                                                <p><strong>Folios:</strong></p>
                                            </div>
                                            <div class="col-sm-8">
                                                <p><?php echo $acto_administrativo->getFolios(); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="col-sm-5">
                                                <p><strong>Punto Radicaci&oacute;n:</strong></p>
                                            </div>
                                            <div class="col-sm-7">
                                                <p><?php echo $acto_administrativo->getRegional(); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (trim($acto_administrativo->getAnexos()) || trim($acto_administrativo->getRuta())) { ?>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="col-sm-4">
                                                <p><strong>Descripci&oacute;n Anexos:</strong></p>
                                            </div>
                                            <div class="col-sm-8">
                                                <p><?php echo $acto_administrativo->getAnexos(); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="col-sm-5">
                                ...
                                <?php if (!empty($acto_administrativo->getObservaciones()) || !empty($acto_administrativo->getTipoIntegracion())) { ?>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-8">
                                                <p><?php echo $acto_administrativo->getObservaciones(); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="col-sm-5">
                                                <p><strong>Tipo Integraci&oacute;n:</strong></p>
                                            </div>
                                            <div class="col-sm-7">
                                                <p><?php echo !empty($acto_administrativo->getTipoIntegracion()) ? trim($acto_administrativo->getTipoIntegracion()) : "(no aplica)"; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (trim($acto_administrativo->getObsAnulacion()) || trim($acto_administrativo->getFechaAnulacion())) { ?>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="col-sm-4">
                                                <p><strong>Observaciones anulaci&oacute;n:</strong></p>
                                            </div>
                                            <div class="col-sm-8">
                                                <p><?php echo $acto_administrativo->getObsAnulacion(); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="col-sm-5">
                                                <p><strong>Fecha de anulaci&oacute;n:</strong></p>
                                            </div>
                                            <div class="col-sm-7">
                                                <p><?php echo $acto_administrativo->getFechaAnulacion(); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (trim($acto_administrativo->getPeriodoId()) || trim($acto_administrativo->getNumeroResolucion())) { ?>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="col-sm-4">
                                                <p><strong>Vingencia:</strong></p>
                                            </div>
                                            <div class="col-sm-8">
                                                <p><?php echo $acto_administrativo->getPeriodoId(); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="col-sm-5">
                                                <p><strong>Fecha Resoluci&oacute;n:</strong></p>
                                            </div>
                                            <div class="col-sm-7">
                                                <p><?php echo $acto_administrativo->getFechaResolucion(); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (trim($acto_administrativo->getRegionalId()) || trim($acto_administrativo->getPrioridadcomId())) { ?>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="col-sm-4">
                                                <p><strong>Ciudad Origen:</strong></p>
                                            </div>
                                            <div class="col-sm-8">
                                                <p><?php echo $acto_administrativo->getRegional()->getCiudad(); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="col-sm-5">
                                            ...
                                            <div class="col-sm-7">
                                                <p><?php echo $acto_administrativo->getPrioridadCom(); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (trim($acto_administrativo->getPlantillascomId()) || trim($acto_administrativo->getSubserieId())) { ?>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-8">
                                                <p><?php echo $acto_administrativo->getPlantillasCom(); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="col-sm-5">
                                                <p><strong>Subserie:</strong></p>
                                            </div>
                                            <div class="col-sm-7">
                                                <p><?php echo sprintf("%s - %s", $acto_administrativo->getSubserie()->getCodigo(), $acto_administrativo->getSubserie()->getDescripcion()); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
    ...
    <script type="text/javascript">
        jQuery(window).on('load', function() {
            jQuery.ajax({
                ...
                data: jQuery.param({
                    actoadministrativo_id: "<?php echo $acto_administrativo->getPrimaryKey(); ?>"
                }),
