...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="panel panel-gradient" data-collapsed="0">
      ...
      <?php 
        echo form_tag('regional/file', array('name'=>'form1', 'multipart'=> true, 'role' => 'form', 'class' => 'form-horizontal form-groups-bordered validate'));
      ?>
...
<?php echo javascript_tag('
   function seleccionar() {
        ...
        if(val != ""){
   		   parent.document.form1.image_membrete.value = val;
