          ...
          <div class="panel-heading">
	        ...
	        <div class="panel-body with-table">              
              <table class="table table-bordered table-hover table-striped responsive">
                  ...
                  <tbody>
                  <?php      
                  //var_dump($pager->getResults()); exit();
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        ...
                        ?>
                        <?php // echo 'comenviada_id: ' . $losRegistrosPendientes->getComenviadaId() . '<br>'; ?>
                        <?php // echo 'tipoprocesocom_id: ' . $tipoprocesocom_id . '<br>'; ?>
                        <?php // echo 'tipoproceso: ' . $losRegistrosPendientes->getTipoprocesocom() . '<br>'; ?>
