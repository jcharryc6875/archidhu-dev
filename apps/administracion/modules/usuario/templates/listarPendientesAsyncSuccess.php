...
//echo 'EL USUARIO ID ES: ' . $usuario_id . '<br>'; echo 'EL PERIODO ID ES: ' . $periodo_id . '<br>'; echo 'EL CONCEPTO ES: ' . $concepto . '<br>'; echo 'LA CANTIDAD DE REGISTROS ES: ' . $cant_regsts . '<br>'; 
