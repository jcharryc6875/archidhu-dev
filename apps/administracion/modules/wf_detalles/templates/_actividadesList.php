    				...
    				<tr>
                        ...
                        <td class="text-center">
                            ...
                            echo jq_link_to_remote(image_tag('simad/ico_edit_property.png',
                            	...
                            	'url'     => $base_path.'/administracion.php/wf_detalles/editByActividad',
                                'with' => "'wf_actividad_id=".$row->getPrimaryKey()."'",
                              ...
                              ),array('class'=>'tooltip-primary','data-toggle'=>'tooltip','data-original-title'=>'Haga clic para editar esta actividad'));
                            ?>
                        </td>
    				</tr>
    				<?php
