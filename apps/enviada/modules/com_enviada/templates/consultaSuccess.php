...
<div class="panel panel-gradient" data-collapsed="0">
  <div class="panel-heading">
    <div class="panel-title">
      Consultar Comunicaci&oacute;n Externa Enviada
    </div>
  </div>
  <!-- Contenedor Contenido Formulario-->
  <div class="panel-body">      
    <?php echo form_tag('com_enviada/list',array('name'=>'form1','method'=>'GET', 'role' => 'form', 'class' => 'form-horizontal form-groups-bordered validate')) ?>
        <div class="form-group">
          ...
          <!-- Entidad Destino -->
         <label for="lbentidaddestino" class="col-sm-1 control-label">Entidad Destino:</label>
          <div class="col-sm-3">
            <?php 
                echo input_tag('entidad_origen', '', array('class'=>'form-control input-sm','placeholder'=>'Buscar por la endiad de destino'));
            ?>
          </div>
          ...
          <div class="col-sm-3">
            <?php
                echo input_tag('funcionario_origen', '', array('class'=>'form-control input-sm','placeholder'=>'Buscar por el funcionario destino'));
            ?>
          </div>      
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <?php 
                echo object_input_tag($com_enviada, 'getAsunto', array('class'=>'form-control input-sm','placeholder'=>'Buscar por el asunto de la comunicaci&oacute;n'));
            ?>
          </div>
    
          <!-- Contenido -->
         <label for="lbrazonsocial" class="col-sm-1 control-label">Contenido:</label>
          <div class="col-sm-3">
            <?php 
                echo object_input_tag($com_enviada, 'getContenido', array('class'=>'form-control input-sm','placeholder'=>'Buscar por el contenido de la comunicaci&oacute;n'));
            ?>
          </div>
          ...
          <div class="col-sm-3">
            <?php
                ...
                echo object_select_tag($com_enviada, 'getPeriodoId', array('related_class' => 'Periodo','include_custom'=>'Seleccione...','class'=>'form-control input-sm'));
            ?>
          </div>      
        </div>
        ...
        <div class="form-group">          
          ...
          <div class="col-sm-3">
            <?php
                echo object_select_tag($com_enviada, 'getEstadocomenviadaId', array ('related_class' => 'EstadoComEnviada','include_custom'=>'Seleccione...','class'=>'form-control input-sm'));                
            ?>
          </div>
          ...
          <div class="col-sm-3">
            <?php                
                echo object_select_tag($com_enviada, 'getEstadodigitalizacionId', array ('related_class' => 'EstadoDigitalizacion','include_custom'=>'Seleccione...','class'=>'form-control input-sm',));
            ?>
          </div> 
		...
		<div class="form-group">
          ...
          <div class="col-sm-5">
            <?php
                echo object_select_tag($com_enviada, 'getDependenciaId', array ('peer_method'=>'getDependenciaAllJoin', 'related_class' => 'Dependencia','include_custom'=>'Seleccione...','class'=>'form-control input-sm select2'));                
            ?>
          </div>    
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <?php
                $ordenList = array('FECHA_CREACION'=>'Fecha','RADICADO'=>'Radicado','ASUNTO'=>'Asunto','NUMERO_RADICACION'=>'Numero de Radicacion');
        ...
        <div class="col-sm-offset-4 col-sm-5">
            <button type="submit" class="btn btn-blue btn-icon">Consultar Enviada<i class="entypo-search"></i></button>            
